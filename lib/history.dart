...
class _SportsQuizState extends State<historyQuiz> {
  int Marks = 0;
  List<Question> questions = [
    Question(
      'who is  richest man ever lived in history?',
      ['mansa musa', 'Hitler', 'geghis ghan', 'plato'],
      'mansa musa ',
    ),
    Question(
      'which is the biggest civilaisation?',
      [
    ...
    Question(
      'in which country hitler born?',
      ['germany', 'sweden', 'austria', 'Britian'],
      'austria',
    ),
    Question(
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text(
              'You have completed the History quiz!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                if (Marks > 3) {
