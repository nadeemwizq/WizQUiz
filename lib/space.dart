...
class _SportsQuizState extends State<spaceQuiz> {
  int Marks = 0;
  List<Question> questions = [
    ...
    Question(
      ...
      ['Venus', 'Neptune', 'Jupiter', 'Earth'],
      'Neptune',
    ),
    Question(
      ' in which year apollo 11 launched?',
      ['1962', '1969', '1945', '1949'],
      '1969',
    ),
    Question(
      'who is the chairman of ISRO while launching chandrayan 3 ?',
      ['k sivan', 'ariyabata', 'APJ abdul kalam', 'somanadan'],
      'somanadan',
    ),
    Question(
      'pick odd one out?',
      ['earth', 'mercury', 'jupiter', 'alpha century'],
      'alpha century',
    ),
  ];
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text(
              'You have completed the Space quiz!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                if (Marks > 3) {
